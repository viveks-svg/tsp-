...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={cn(
          "fixed top-[33px] left-0 right-0 z-50 w-full transition-all duration-500 ease-out",
          mounted && (scrolled || pathname !== "/")
            ? "bg-[#0F0E0C]/90 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] border-b border-white/[0.04] py-2"
            : "bg-transparent py-4"
        )}
      >
