...
export const metadata: Metadata = {
  title: "Free Daily Tarot Card Reading | Astro Space",
  description: "Draw from the mystical deck for instant guidance on love, career, and choices.",
};

export default function TarotPage() {
  const item = freeServices.find((s) => s.id === "tarot");
  ...
  return (
    ...
    >
      <div className="bg-card rounded-2xl p-6 border border-border shadow-card">
        <FreeServicePageClient slug="tarot" />
      </div>
    </ToolPageLayout>
  );
}
