...
export const metadata: Metadata = {
  title: "Privacy Policy | Time Space & Planets",
  description: "Privacy policy for Time Space & Planets.",
};
    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="bg-gradient-navy text-white pt-[125px] pb-16 lg:pt-[140px] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-cream/80 max-w-2xl mx-auto text-sm md:text-base font-inter leading-relaxed">
            We value your privacy and are currently updating our privacy policy document.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl border border-border p-10 shadow-card text-center">
          <ShieldCheck className="w-10 h-10 text-gold mx-auto mb-4 opacity-60" />
          ...
          <p className="text-sm text-paragraph max-w-lg mx-auto mb-6 leading-relaxed">
            Our legal team is finalizing the Privacy Policy to ensure compliance and transparency regarding how we handle your data. It will be published here shortly.
          </p>
          <Link
            href={ROUTES.HOME}
